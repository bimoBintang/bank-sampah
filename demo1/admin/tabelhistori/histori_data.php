...
if(!isset($_SESSION['login_admin'])){
 ...
 if (isset($_POST["cari"])) {
   ...
   $sql_tampil = "SELECT data_user.*, data_transaksi.* FROM data_user INNER JOIN data_transaksi ON data_user.id_user=data_transaksi.user WHERE data_transaksi.status_transaksi='Selesai' OR data_transaksi.status_transaksi='Dibatalkan' AND (id_transaksi LIKE '%$keyword%' OR nama LIKE '%$keyword%' keterangan LIKE '%$keyword%')";
  }
...
<head>
  ...
  <title>Riwayat Data Transaksi</title>
      ...
      <div class="kotak-atas">
        ...
        <div class="kotak2">
          <div>
            <br>
            <div class="btn">
              <a href="histori_print.php" class="btn-a">PRINT</a>
            </div>
          </div>
        ...
        <table class="w-table" cellpadding="10">
          ...
          ?>
            <tr>
              ...
              <td>
                <a href="transaksi_hapus.php?id_transaksi=<?= $transaksi['id_transaksi'] ?>" class="hapus" onclick="return confirm('Yakin Hapus')">Hapus</a>
              </td>
            </tr>
          <?php 
          $number++;
