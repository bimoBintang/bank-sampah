...
<head>
  ...
  <title>Halaman Tambah Data Petugas</title>
...
<body>
  ...
  <div class="container">
    ...
    <div class="kotak-atas">
        <div class="text">
          <h2 class="title-input-data">Tambah Data Petugas</h2>
        </div>
        <form method="POST">
  ...
  if(isset($_POST['create'])){
    ...
    $sql_create="INSERT INTO data_user(id_user, nik, password, hak_akses, nama, email, telepon, alamat, rt) VALUES ('','$nokk','333333','Petugas','$nama','$email', '$telepon', '$alamat', '$rt')";
