...
<head>
  ...
  <title>Edit Riwayat Transaksi</title>
    ...
    <div class="kotak-atas">
        ...
        <div class="form-input">
            ...
            <div class="right-coloumn">
                ...
                <div class="form-group">
                    <p class="caption-form">Tanggal Transaksi</p>
                    <input class="input-edit" name='rt' name="waktu" type="datetime-local" required value="<?= $data_tampil['tanggal_transaksi']?>" disabled>
                </div>
                <div class="form-group">
